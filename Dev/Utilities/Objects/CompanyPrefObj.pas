...
//      FbHasWooCommerceCredentials                        : Boolean;
      ...
      FbWooCommerceSendProductOptions                    : Boolean;
...
//      FbWooCommerce_AutocheckforOrdersinList             : Boolean;
    ...
    procedure setSendWooCommerceProductOptions(const Value: Boolean);
...
//    Property TransLinesToDisableCalcs: Integer Read FiTransLinesToDisableCalcs Write FiTransLinesToDisableCalcs;
    ...
    Property WooCommerceSendProductOptions: Boolean Read FbWooCommerceSendProductOptions write setSendWooCommerceProductOptions;
...
//    fWooCommerce_URL                            := FieldByName('WooCommerce_URL').AsString;
    ...
    FbWooCommerceSendProductOptions             := (FieldByName('WooCommerceSendProductOptions').AsString = 'T') and FbEnableWooCommerce;
...
procedure TCompanyPrefObj.setSendWooCommerceProductOptions(const Value: Boolean);
begin
  If Value <> FbWooCommerceSendProductOptions Then Begin
    WooCommerceSendProductOptions := Value;
    StoreFieldValue('WooCommerceSendProductOptions', Value);
  End;
end;
