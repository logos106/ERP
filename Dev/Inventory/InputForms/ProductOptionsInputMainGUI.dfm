inherited frmProductOptionsMain: TfrmProductOptionsMain
  ...
  inherited imgsort: TImageList
    Bitmap = {
      494C010102004801800310001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object qryProductHeader: TERPQuery
    ...
    object qryProductHeaderGlobalRef: TWideStringField
      FieldName = 'GlobalRef'
      Size = 255
    end
    object qryProductHeadermsTimeStamp: TDateTimeField
      FieldName = 'msTimeStamp'
    end
    object qryProductHeadermsUpdateSiteCode: TWideStringField
  ...
  object qryProductDetails: TERPQuery
    ...
    AfterPost = qryProductDetailsAfterPost
    Options.LongStrings = False
    Left = 706
    Top = 56
    ParamData = <
