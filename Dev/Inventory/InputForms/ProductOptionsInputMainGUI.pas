...
type
  TfrmProductOptionsMain = class(TBaseInputGUI)
    ...
    qryProductHeaderGlobalRef: TWideStringField;
    qryProductHeadermsTimeStamp: TDateTimeField;
    qryProductHeadermsUpdateSiteCode: TWideStringField;
    ...
    procedure qryProductDetailsAfterPost(DataSet: TDataSet);
  private
...
procedure TfrmProductOptionsMain.qryProductDetailsAfterPost(DataSet: TDataSet);
begin
  inherited;
  qryProductHeader.Edit;
  qryProductHeader.FieldByName('MSTIMESTAMP').AsDateTime := Now(); // tickle the master as well
  qryProductHeader.Post;
end;
