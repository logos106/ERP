inherited IntegrationPrefsGUI: TIntegrationPrefsGUI
  ...
  inherited sbpanels: TAdvScrollBox
    ...
    object pnlWooCommerceOptions: TDNMPanel
      ...
      object chkWooCSendProductOptions: TwwCheckBox
        Left = 305
        Top = 58
        Width = 150
        Height = 17
        ...
        NullAndBlankState = cbUnchecked
        Alignment = taLeftJustify
        Caption = 'Send Product Options'
        DataField = 'WooCommerceSendProductOptions'
        DataSource = dsPrefs
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
